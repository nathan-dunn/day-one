...
program
  ...
  .addSession(
    ...
    new Lift(
      SQUAT,
      'Rest 2-3 mins between sets. Keep rest minimal while preserving form and focusing on bar speed. You may pause all or some of the reps in order to increase difficulty.',
      new Rx(3, 5, 0.6)
    ),
    new Lift(
      BENCH,
      'Perform this exercise with a narrow / close grip in order to increase difficulty. You may also institute a 2-3 count pause in order to increase difficulty. Rest 2-3 mins between sets. Keep rest minimal while preserving form and focusing on bar speed. On the final set you may push for more reps, stopping 1-2 reps shy of failure.',
      new Rx(3, 5, 0.6)
    ),
    new Lift(
      CHINS_OR_PULLUPS,
      'Rest 2-3 minutes between sets. If you cannot do Chins/Pull Ups then sub with Lat Pulldowns for sets of 8-12 reps or Bodyweight Rows for sets of 10-15 reps. If you can only do a few chins/pull ups then perform as many sets as needed to achieve 20-25 total reps minimum. If you can do more than 15 reps per set, add weight.',
      new Rx(5, 'AMRAP')
    ),
    new Lift(
      ARMS,
      'Pick one bicep exercise and one tricep exercise and move back and forth between the two for 2-3 sets. Rest about 1 minute between each exercise until all sets are complete.',
      new Rx('2-3', '10-15')
    )
  );
